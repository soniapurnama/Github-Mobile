...
class UserFollowerListAdapter (val onItemClicked: OnItemClicked) : RecyclerView.Adapter<UserFollowerListAdapter.UserFollowerListHolder>(){

    var items :ArrayList<User> = arrayListOf()
    var listDataFiltered : ArrayList<User> = arrayListOf()
    class UserFollowerListHolder(view: View) : RecyclerView.ViewHolder(view)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): UserFollowerListHolder{
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_user,parent,false)
        return UserFollowerListHolder(
                view
        )
    }
    ...
    override fun onBindViewHolder(holderUser: UserFollowerListHolder, position: Int) {
